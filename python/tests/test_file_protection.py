...
class TestHomeDirectoryProtection:
    ...
    @pytest.mark.skipif(platform.system() == "Windows", reason="Linux paths not applicable on Windows")
...
class TestIntegrationScenarios:
    ...
    def test_project_with_mcp_clone_inside(self, tmp_path):
        ...
        # User files should be included (use Path for platform-independent checks)
