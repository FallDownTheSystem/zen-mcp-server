...
def configure_providers():
    ...
    from providers.async_openai_provider import AsyncOpenAIProvider
    ...
    if openai_key and openai_key != "your_openai_api_key_here":
        ...
        has_native_apis = True
        logger.info("OpenAI API key found - o3 models available (using async provider)")
    ...
    if has_native_apis:
        ...
        if openai_key and openai_key != "your_openai_api_key_here":
            ModelProviderRegistry.register_provider(ProviderType.OPENAI, AsyncOpenAIProvider)
        if xai_key and xai_key != "your_xai_api_key_here":
